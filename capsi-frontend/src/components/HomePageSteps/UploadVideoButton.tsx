...
const UploadDiv = styled.div<{ isMobile: boolean, isTablet: boolean }>`
  display: flex;
...
const UploadVideoButton = () => {
    ...
    const inputFile=useAppStore((state:any)=>state.inputFile);
    const inputVideo = useAppStore(({ inputVideo }: any) => inputVideo)
    const setInputFile=useAppStore((state:any)=>state.setInputFile)
